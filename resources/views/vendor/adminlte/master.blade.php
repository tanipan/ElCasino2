...
<body class="@yield('classes_body')" @yield('body_data') style="background-color: var(--tema-color)">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.customer.search') }}" method="GET" id="formTelefono">
                ...
                <div class="modal-footer">
                    ...
                    <button type="boton" class="btn btn-success" id="buscarCliente">Buscar Cliente</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $('#telefonoModal').on('show.bs.modal', function() {
            $('#telefono').val('');
        });
        $('#telefonoModal').on('shown.bs.modal', function() {
