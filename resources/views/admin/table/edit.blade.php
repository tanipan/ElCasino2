    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('admin.table.update', $table) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                value="{{ old('name', $table->name) }}" name="name" placeholder="Inserta la mesa">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('location') is-invalid @enderror" id="location"
                                ...
                                @foreach ($locations as $location)
                                    <option {{ $table->location == $location->id ? 'selected' : 'selected' }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="orderWithoutWaiter"
                                    name="orderWithoutWaiter" value="1"
                                    {{ $table->orderWithoutWaiter ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('eaters') is-invalid @enderror" id="eaters"
                                value="{{ old('eaters', $table->eaters) }}" name="eaters"
                                placeholder="Inserta el número de comensales">
                            @error('eaters')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary float-right">Modificar mesa</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
