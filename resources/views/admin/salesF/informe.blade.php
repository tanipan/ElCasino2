        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <form action="{{ route('admin.sales.informe') }}" method="GET" id="formu_filter">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <a href="{{ route('admin.sales.informe') }}" class="btn btn-danger btn-sm">Limpiar</a>
                            </div>
                        </div>
                    </form>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @foreach ($ventasAux as $key => $venta)
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($venta as $item)
                                                    @php
                                                        $carbon = new Carbon\Carbon($item->created_at);
                                                        // Formatear la fecha según el formato deseado
                                                        $fechaFormateada = $carbon->format('H:i:s d-m-Y');
                                                    @endphp
                                                    <tr>
                                                        <td>{{ explode('#', $item->burger)[0] }}</td>
                                                        <td>
                                                            {{ $item->units }}
                                                        </td>
                                                    ...
                                                    @php
                                                        ...
                                                        if (explode('#', $item->burger)[0] == 'CHEESECAKE') {
                                                            $totalCake += $item->units;
                                                        }
                                                        if (explode('#', $item->burger)[0] == 'CHEESECAKE+TOPPING') {
                                                            $totalCakePlus += $item->units;
                                                        }
                                                    @endphp
                                                @endforeach
                                            </tbody>
                                    ...
                                    <div class="card-footer clearfix" style="text-align: right">
                                        @if ($key == 'PANADERIA EL ROJO')
                                            <h5>TOTAL cheesecake: {{ $totalCake }} porciones</h5>
                                            <h5>TOTAL cheesecake+topping: {{ $totalCakePlus }}
                                                porciones</h5>
                                        @else
                                            <h5>TOTAL: {{ $total }} burgers</h5>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
