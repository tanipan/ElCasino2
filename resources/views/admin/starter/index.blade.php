...
@section('js')
    ...
    <script>
        function kanban_reload() {
            $.get('{{ route('admin.starters.reload') }}', {}, function(data) {
                ...
                function marcarLinea(order_line) {
                    $.get('{{ route('admin.orderline.prepared') }}', {
                ...
                function desmarcarLinea(order_line) {
                    $.get('{{ route('admin.orderline.unprepared') }}', {
                        order_line: order_line
                    }, function(resp) {
                        kanban_reload();
                    });
                ...
                function ocultarPedido(order) {
                    $.get('{{ route('admin.orderline.orderHide') }}', {
                        order_id: order
                    }, function(resp) {
                        kanban_reload();
                    });
