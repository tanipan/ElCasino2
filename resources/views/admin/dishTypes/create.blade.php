...
@section('title', 'Crear nuevo tipo de plato')
        ...
        <div class="col-md-6">
            ...
            <div class="card card-success">
                <div class="card-header">
                    <h3 class="card-title">Datos del nuevo tipo de plato</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('admin.dishType.store') }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                value="{{ old('slug') }}" name="slug" placeholder="Inserta el slug">
                            @error('slug')
                                <span class="error invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('hidden') is-invalid @enderror" id="hidden"
                                    name="hidden">
                                    <option {{ old('hidden') == '0' ? 'selected' : '' }} value="0">No
                                    </option>
                                    <option {{ old('hidden') == '1' ? 'selected' : '' }} value="1">Si
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('manageStock') is-invalid @enderror" id="manageStock"
                                    name="manageStock">
                                    <option {{ old('manageStock') == '0' ? 'selected' : '' }} value="0">No
                                    </option>
                                    <option {{ old('manageStock') == '1' ? 'selected' : '' }} value="1">Si
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="waiter_only"
                                    name="waiter_only">
                                    <option {{ old('waiter_only') == '0' ? 'selected' : '' }} value="0">No
                                    </option>
                                    <option {{ old('waiter_only') == '1' ? 'selected' : '' }} value="1">Si
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class=" form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="room_only"
                                    name="room_only">
                                    <option {{ old('room_only') == '0' ? 'selected' : '' }} value="0">No
                                    </option>
                                    <option {{ old('room_only') == '1' ? 'selected' : '' }} value="1">Si
                                    </option>
                                </select>
                            </div>
                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="mondayTurn">
                                                <option value="allDay">Todo el dia</option>
                                                <option value="atMeals">Solo comidas</option>
                                                <option value="atDinners">Solo cenas</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheckWednesday"
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary float-right">Crear tipo de plato</button>
                    </div>
                </form>
            </div>
            <!-- /.card -->
